...
const storage = new Storage({
    projectId: "delivery-16a05",
    keyFilename: './serviceAccountKey.json'//archivo que hace el enlaze con farebase
});

const bucket = storage.bucket("gs://delivery-16a05.appspot.com/");
